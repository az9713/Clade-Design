...
| Provider flexibility | Anthropic only | 7+ via [`pi-ai`][piai] | **13 CLI adapters + OpenAI-compatible BYOK proxy** |
...
- [x] Daemon + agent detection (13 CLI adapters) + skill registry + design-system catalog
