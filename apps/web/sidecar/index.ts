import { APP_KEYS, OPEN_DESIGN_SIDECAR_CONTRACT } from "@clade/sidecar-proto";
import { bootstrapSidecarRuntime } from "@clade/sidecar";
import { readProcessStamp } from "@clade/platform";
