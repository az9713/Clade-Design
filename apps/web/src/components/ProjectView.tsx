...
import { composeSystemPrompt } from '@clade/contracts';
...
export function ProjectView({
  ...
  const handleDirectionPick = useCallback(async (philosophyId: string) => {
  ...
  return (
    ...
    {directionPending && (
      <DirectionPicker
        directions={directionPending.directions}
